  ...
  def parseDefinition(text: String): Define = {
    ...
    text match {
      ...
      case nonContextCmd =>
        ...
        Initialism.from(defcmd.head) match {
          case Success(i) => DefineInitialism(null, i, Term.from(defcmd.last)) // TODO: make context optional field
          case Failure(e) => DefineTerm(null, Term.from(defcmd.head), Exposition(defcmd.last)) // TODO: make context optional field
        }
    }
  }
    ...
    text match {
      ...
      case nonContextCmd =>
        Initialism.from(nonContextCmd) match {
          case Success(i) => LookupInitialism(null, i) // TODO: make context optional field
          case Failure(e) => LookupTerm(null, Term.from(nonContextCmd)) // TODO: make context optional field
        }
    }
  }
